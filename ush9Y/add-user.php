...
{
$status=shell_exec("bash /var/www/rbac/add-user.sh -u '".$clientname."' -p '".$pass."' -c '".$circuitid."' -s '".$space."'");
$new_str = preg_replace("/\s+/", "", $status);
if ($new_str == "user-exist")
{
	echo "<body class='hold-transition register-page'>";
	echo "<script language='javascript'>";
...
<body class="hold-transition register-page">
    <div class="register-box">
        <div class="register-box-body">
            ...
            <br />
            <center>
                <button type="submit" name="submit" style="width: 130px" class="btn btn-primary btn-block btn-flat">Add
                    User</button>
            </center>
            </form>
            <br />
